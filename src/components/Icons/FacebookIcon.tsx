...
export const FacebookIcon: React.FC<FacebookIconProps> = ({color = "#000000", width = 10, height = 20}) => (
    <svg width={width} height={height} viewBox="0 0 10 20" xmlns="http://www.w3.org/2000/svg">
        <path
